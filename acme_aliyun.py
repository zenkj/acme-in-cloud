#!/usr/bin/env python
# Based on Daniel Roesler's awesome acme-tiny, see github.com/diafygi/acme-tiny
...
def get_crt(account_key, csr, aliyun_access_key, log=LOGGER, CA=DEFAULT_CA, disable_check=False, directory_url=DEFAULT_DIRECTORY_URL, contact=None):
    ...
    for auth_url in order['authorizations']:
        ...
        # find the dns-01 challenge and update the txt record
...
def main(argv=None):
    ...
    parser.add_argument("--aliyun-access-key", required=True, help="path to your aliyun AccessKey")
    ...
    signed_crt = get_crt(args.account_key, args.csr, args.aliyun_access_key, log=LOGGER, CA=args.ca, disable_check=args.disable_check, directory_url=args.directory_url, contact=args.contact)
